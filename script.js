...
var products = [
    {
        ...
        description: "Gaming Headset, Stereo Sound , Sound Enhancement for FPS Games, Noise Isolating Mic",
        price: 600,
        src: "imgs/1.jpg"
    },
    {
        ...
        description: "Portable Wireless Bluetooth Speakers, Touch Control Bedside Table Light,Outdoor Speakers Bluetooth",
        price: 117,
        src: "imgs/2.jpg"
    },
    {
        id: 2,
        name: "REDRAGON K611",
        description: "BES Gaming Mechanical TKL Keyboard - White Backlighting and Side RGB Light - Blue Switch - AR/EN key ",
        price: 999,
        src: "imgs/3.jpg"
    },
    {
        id: 3,
        name: "TL-WA850RE",
        description: "Signal Rate: 11n: Up to 300Mbps dynamic, Good Quality with a high end, TP-Link TL-WA850RE Wi-Fi Range Extender",
        price: 275,
        src: "imgs/4.jpg"
    },
    {
        id: 4,
        name: "Meetion GM015",
        description: "Lightweight Honeycomb RGB Gaming Mouse (6400 DPI) – For PC & Laptop – Black",
        price: 170,
        src: "imgs/5.jpg"
    },
    {
        id: 5,
        name: "Computer Stand",
        description: "Choetech Foldable Computer Stand,Choetech Foldable Computer Stand",
        price: 230,
        src: "imgs/6.jpg"
    },
    {
        id: 6,
        name: "Mini PC",
        description: "Windows 11 Pro Intel 4-Core J4125 128G M.2 SSD TRIGKEY N4 Working Micro PC Computer",
        price: 6000,
        src: "imgs/7.jpg"
    },
    {
        ...
        description: "High-Volume, Low-Cost Printing And Innovation Design- Get Up To 18,000 ",
        price: 3000,
        src: "imgs/8.jpg"
    }
];
...
function onloadPage() {
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        <div class="card-body">
            ...
            <a class="btn btn-warning" onclick="addToCard(${products[i].id})" >Add To Card</a>
        </div>
        </div>
        `;
    }
    ...
    for (var i = 0; i < cardProducts.length; i++) {
        ...
        <div class="row g-0">
            ...
            <div class="col-8">
                ...
                <button style="width:20%;" type="button" class=" btn btn-warning m-1" onclick="increaseCount(${cardProducts[i].id})">+</button>
                </div>
                </div>
                </div>
            </div>
